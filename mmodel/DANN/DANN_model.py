...
from .DANN_params import params
...
class DANNModule(TrainableModule):
    def __init__(self):
    ...
    def _regist_networks(self):
        ...
        return {
            "F": ResnetFeat(),
            "C": ResnetCls(out_dim=self.cls_info['cls_num'], bottle_neck_dim=256),
            "D": DisNet(
                in_feat_dim=2048,
                adv_coeff_fn=lambda: dy_adv_coeff(self.current_step)),
            "Cet": CenterLoss(num_classes=self.cls_info['cls_num'], feat_dim=256),
        }
